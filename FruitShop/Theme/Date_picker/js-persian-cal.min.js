...
AMIB.persianCalendar = function (b, a) {
    ...
    } var f = this; d.ondblclick = function (a) { f.showHidePicker(a); return !1 }; var h = this; d.onblur = function () { h.normalizeUserInput() }; var k = this; addEvent(d, "keydown", function (a) { k.keyDownHandler(a, k) }); c.initialDate && this.fillDateField(c.initialDate)
};
...
AMIB.persianCalendar.prototype.createDateTable = function (b, a, c) {
    ...
    b.appendChild(d)
}; AMIB.persianCalendar.prototype.changePickerDate = function (b, a, c) { var d; if (d = A$(this.inputID + "_pDatePicker")) b || (b = window.event), stopPropagation(b), b = a.toString() + "/" + c.toString() + "/1", this.createDateTable(d, b, this.input.value) };
AMIB.persianCalendar.prototype.showMonthPicker = function (b, a, c) {
    var d, e, g; if (A$(this.inputID + "_pDatePicker")) {
        b || (b = window.event); (e = A$(lastOpenPDateMonthYearID)) && e.parentNode.removeChild(e); stopPropagation(b); e = cE("div"); e.className = "monthYearPicker"; e.id = lastOpenPDateMonthYearID = this.inputID + "monthYearPicker"; for (d = 0; 12 > d; ++d) g = cE("a"), g.href = "#", g.appendChild(cTN(PERSIAN_MONTH_NAMES[d])), d == a - 1 && (g.className = "selected"), g.onclick = function (a, b, c) {
            return function (d) {
                a.monthYearPickerClick(d, b, c);
                return !1
            }
        }(this, d + 1, c), e.appendChild(g); document.body.appendChild(e); this.setMenuPos(e, b.target || b.srcElement); e.style.zIndex = ++pDatePickerZIndex
    }
};
